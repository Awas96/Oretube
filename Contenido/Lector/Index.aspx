<%@ Page Language="VB" MasterPageFile="~/base.master" AutoEventWireup="false" CodeFile="Index.aspx.vb" Inherits="Contenido_Lector_Index" %>
        ...
        <ItemTemplate>
            <div class="asideContent">
                <div class="imagenVideo">
                    <mi:miImagen ID="imagenBarraLateral" runat="server" SetUrl='<%# "~/Contenido/Lector/Index.aspx" %>' SetSrc='<%# Eval("url") %>' />
                </div>
