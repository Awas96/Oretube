...
Partial Class Contenido_Editor_Index
    ...
    Private Sub Contenido_Editor_Index_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim query = Request.QueryString("vid")
        If query = "" Then
            FVEscribirComentario.Visible = False
            LVComentarios.Visible = False
        Else
            FVEscribirComentario.Visible = True
            LVComentarios.Visible = True
        End If
    End Sub
